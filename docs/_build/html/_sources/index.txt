...
This package contains a simple set of models and admin helper classes
that allow you to add media attachments to any model.
...
2.0, please make sure to update your code to use ``bambu_attachments``
rather than ``bambu.attachments``.
